...
import { AddCalendarioComponent } from './add-calendario/add-calendario.component';
...
@NgModule({
  ...
  declarations: [AddCalendarioComponent, ListCalendarioComponent, IndexCalendarioComponent],
